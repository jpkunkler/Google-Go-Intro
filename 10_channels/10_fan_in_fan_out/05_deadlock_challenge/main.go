...
func fanOut(in <-chan int, n int) []<-chan int {
	var xc []<-chan int // this slice of receive-only channels needs to be initialized with 0 value
	// otherwise, if we initialize it with lenght & capacity of n, that capacity will overflow while appending
	for i := 0; i < n; i++ {
